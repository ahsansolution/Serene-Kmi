...
namespace KBT.DIS {
    ...
    export class ProductExcelImportBulkAction extends Common.ImportExcelServiceAction {
        ...
        protected executeForBatch(batch) {
            ProductsService.ProductBulkAction(
                {
                    ProductIDs: batch.map(x => Q.parseInteger(x))
                },
