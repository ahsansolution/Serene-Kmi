...
using Northwind = KBT.Northwind.Pages;
using Administration = KBT.Administration.Pages;
using Basic = KBT.BasicSamples.Pages;
using DIS = KBT.DIS.Pages;

[assembly: NavigationLink(900, "Dashboard", url: "~/", permission: "", icon: "icon-speedometer")]
...
[assembly: NavigationMenu(9000, "Administration", icon: "fa-book")]
[assembly: NavigationLink(9100, "Administration/Languages", typeof(Administration.LanguageController), icon: "fa-circle-o")]
[assembly: NavigationLink(9200, "Administration/Translations", typeof(Administration.TranslationController), icon: "fa-circle-o")]
[assembly: NavigationLink(9300, "Administration/Roles", typeof(Administration.RoleController), icon: "fa-circle-o")]
[assembly: NavigationLink(9400, "Administration/User Management", typeof(Administration.UserController), icon: "fa-circle-o")]


[assembly: NavigationMenu(1000, "Master", icon: "fa-list-alt")]
[assembly: NavigationLink(1001, "Master/Company", typeof(DIS.CompanyController), icon: "fa-circle-o")]
[assembly: NavigationLink(1002, "Master/Order Category", typeof(DIS.OrderCategoryController), icon: "fa-circle-o")]
//[assembly: NavigationLink(1003, "Master/Product Category", typeof(DIS.ProductCategoryController), icon: "icon-lock")]
[assembly: NavigationLink(1004, "Master/Product Type", typeof(DIS.ProductTypeController), icon: "fa-circle-o")]
[assembly: NavigationLink(1005, "Master/Product", typeof(DIS.ProductsController), icon: "fa-circle-o")]
[assembly: NavigationLink(1006, "Master/Product Price", typeof(DIS.ProductPriceController), icon: "fa-circle-o")]
[assembly: NavigationLink(1007, "Master/Inventory", typeof(DIS.ViewProductStockController), icon: "fa-circle-o")]
[assembly: NavigationLink(1008, "Master/Product Tracking", typeof(DIS.InventoryController), icon: "fa-circle-o")]
[assembly: NavigationLink(1009, "Master/Customer", typeof(DIS.CustomerDealerController), icon: "fa-circle-o")]
[assembly: NavigationLink(1010, "Master/Product Base Price", typeof(DIS.ProductBasePriceController), icon: "fa-circle-o")]
[assembly: NavigationLink(1011, "Master/Supplier", typeof(DIS.SupplierController), icon: "fa-circle-o")]
//[assembly: NavigationLink(1012, "Master/Upload", typeof(DIS.UploadFileController), icon: "fa-circle-o")]



[assembly: NavigationMenu(2000, "Transaction", icon: "fa-credit-card")]
[assembly: NavigationLink(2001, "Transaction/Purchase Order", typeof(DIS.PurchaseOrderController), icon: "fa-circle-o")]
[assembly: NavigationLink(2002, "Transaction/Receive Order", typeof(DIS.ReceiveOrderController), icon: "fa-circle-o")]
//[assembly: NavigationLink(2003, "Transaction/Receive Order Detail", typeof(DIS.ReceiveOrderDetailController), icon: "icon-bubbles")]
[assembly: NavigationMenu(2004, "Transaction/Orders", icon: "fa-credit-card")]
[assembly: NavigationLink(2005, "Transaction/Orders/Spare Part & Unit", typeof(DIS.OrdersController), icon: "fa-circle-o")]
[assembly: NavigationLink(2006, "Transaction/Orders/Service Unit", typeof(DIS.ServiceUnitController), icon: "fa-circle-o")]