        ...
        public ActionResult Index()
        {
            var cachedModel = TwoLevelCache.GetLocalStoreOnly("DashboardPageModel", TimeSpan.FromMinutes(5),
                OrderRow.Fields.GenerationKey, () =>
                {
                    ...
                    //var or = OrdersRow.Fields;
                    //using (var connection = SqlConnections.NewFor<OrdersRow>())
                    //{
                    //    model.OpenOrders = connection.Count<OrdersRow>();
                    //}

                    //var po = PurchaseOrderRow.Fields;
                    //using (var connection = SqlConnections.NewFor<PurchaseOrderRow>())
                    //{
                    //    model.OpenOrders = connection.Count<PurchaseOrderRow>();
                    //}


                    //var st = ViewProductStockRow.Fields;
                    //using (var connection = SqlConnections.NewFor<ViewProductStockRow>())
                    //{
                    //    model.OpenOrders = connection.Count<ViewProductStockRow>();
                    //}
